...
*One-month Academic Project, 2024*
...
* Extraction of the **diffusion coefficient** via linear regression of the mean squared displacement ($\langle r^2 \rangle \propto t$).
